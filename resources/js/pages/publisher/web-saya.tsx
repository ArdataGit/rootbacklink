                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-3 gap-3 border-y border-gray-100 py-4">
                                        <div>
                                            ...
                                            <input type="number" value={data.da} onChange={e => setData('da', e.target.value)} className="w-full px-3 py-2 border border-gray-200 rounded-lg bg-gray-50 text-sm focus:ring-2 focus:ring-teal-500 focus:border-transparent" placeholder="0" />
                                            {errors.da && <p className="mt-1 text-[10px] text-red-500">{errors.da}</p>}
                                        </div>
                                        <div>
                                            <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">PA</label>
                                            <input type="number" value={data.pa} onChange={e => setData('pa', e.target.value)} className="w-full px-3 py-2 border border-gray-200 rounded-lg bg-gray-50 text-sm focus:ring-2 focus:ring-teal-500 focus:border-transparent" placeholder="0" />
                                            {errors.pa && <p className="mt-1 text-[10px] text-red-500">{errors.pa}</p>}
                                        </div>
                                        <div>
                                            <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">SS (%)</label>
                                            <input type="number" value={data.ss} onChange={e => setData('ss', e.target.value)} className="w-full px-3 py-2 border border-gray-200 rounded-lg bg-gray-50 text-sm focus:ring-2 focus:ring-teal-500 focus:border-transparent" placeholder="0" />
                                            {errors.ss && <p className="mt-1 text-[10px] text-red-500">{errors.ss}</p>}
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="number" value={data.traffic} onChange={e => setData('traffic', e.target.value)} className="w-full px-4 py-2.5 border border-gray-200 rounded-lg bg-gray-50 text-sm focus:ring-2 focus:ring-teal-500 focus:border-transparent" placeholder="1000" />
                                            {errors.traffic && <p className="mt-1 text-xs text-red-500">{errors.traffic}</p>}
                                        </div>
                                        <div>
                                            <label className="block text-sm font-semibold text-gray-600 mb-1">Indeks Google</label>
                                            <select value={data.indexing} onChange={e => setData('indexing', e.target.value)} className="w-full px-4 py-2.5 border border-gray-200 rounded-lg bg-gray-50 text-sm focus:ring-2 focus:ring-teal-500 focus:border-transparent">
